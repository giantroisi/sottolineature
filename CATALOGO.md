...
| 5 | Copertine delle opere rimaste | **ripreso e in gran parte chiuso il 2026-09-06**: il blocco non era Open Library, era la lingua della ricerca — col titolo italiano si trovano 3 copertine su 60, col titolo originale 12 su 15. Le 109 opere sono state divise in **91 libri** e **18 testi brevi** (poesie singole, saggi, discorsi, lettere: non hanno un'edizione propria, la copertina non esistera' mai — segnaposto definitivo, non riaprire). Sugli 82 libri con titolo di ricerca affidabile: 48 candidati, **11 scartati guardandoli** (l'adattamento di Arthur Miller al posto di Ibsen, una pagina di note al posto di una copertina, sei legature anonime), **37 applicati** a 42 citazioni. Da 109 opere scoperte a **72**. La classificazione con i titoli originali sta in `tools/copertine_titoli.json`: le 9 opere con `orig` vuoto e le 34 senza candidato sono cio' che resta da fare |
