...
### Fatto
- 256 citazioni, 241 copertine recuperate + tile placeholder per le 15 mancanti, contesto su 127 citazioni (9 aggiunte con citazioni nuove, 118 aggiunte retroattivamente a citazioni già presenti — standard per le nuove da qui in poi). Nota: il numero di copertine era rimasto non aggiornato per diversi lotti passati (indicava ancora "34", risalente a uno stato molto più piccolo del sito) — corretto qui al valore reale contato dal file
- **90 contesti aggiunti in una sola giornata (2026-08-28), in autonomia** su richiesta esplicita dell'utente — dettagli completi in LOG.md. Due citazioni scartate per assenza di conferma sul parlante esatto (Dostoevskij "Delitto e castigo", Veronesi "Il colibrì"), da ritentare quando la ricerca web tornerà disponibile (limite settimanale esaurito, si ripristina il 2026-08-30). Lezione operativa: quando lo stesso autore/titolo compare più volte sul sito, un contesto scritto per una citazione può finire applicato per errore anche alle altre con lo stesso titolo se lo script di inserimento non controlla i duplicati — sempre bene un controllo automatico post-inserimento (nessun contesto identico su citazioni diverse) prima di pubblicare
...
- **Contesto per le restanti 129 citazioni** — il cantiere grande, da fare a lotti
