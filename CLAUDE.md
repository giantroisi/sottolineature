...
- **Verificare l'attribuzione del titolo per la citazione di Naguib Mahfouz** — vedi nota sopra, possibile libro sbagliato già pubblicato ("Il palazzo del desiderio" vs "Vicolo del mortaio")
- **Contesto per le ultime 3 citazioni** — Dostoevskij, Sciascia, Mahfouz: da ritentare solo se emerge una fonte primaria (es. testo del romanzo su Wikisource/Google Libri), non ha senso riprovare con le stesse ricerche generiche già fatte più volte
