...
### Fatto
- 256 citazioni, 241 copertine recuperate + tile placeholder per le 15 mancanti, **contesto su 254/256 citazioni — cantiere sostanzialmente concluso**. Nota: il numero di copertine era rimasto non aggiornato per diversi lotti passati (indicava ancora "34", risalente a uno stato molto più piccolo del sito) — corretto qui al valore reale contato dal file
