...
"una volta completata anche quella, aggiungine di nuove"): archivio passato da 220 a 223
autori con l'aggiunta di E.M. Forster, T.S. Eliot, Agatha Christie (ciascuno con una
citazione, quindi sotto soglia di indicizzazione — verranno approfonditi in lotti futuri
insieme ai 35 rimasti dal lavoro precedente). Lavoro da proseguire senza chiedere conferma:
sia nuovi autori sia, quando si trova una fonte solida, approfondimento dei 35+3 = 38 autori
