...
Szymborska, Heaney); ne restano 122 con una sola — lavoro esplicitamente da proseguire senza
chiedere conferma, poi passare a nuove citazioni una volta esaurito, **anche per ore senza il
controllo dell'utente** (istruzione del 2026-08-28). Script di inserimento aggiornato: rifiuta
...
quindi la build falliva sempre dopo ogni lotto — vedi LOG.md. Archivio a 357 citazioni, 220
